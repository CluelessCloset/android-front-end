...
import com.stocks.cluelesscloset.POKO.Top
import com.stocks.cluelesscloset.R

/**
 * Adapter for displaying the user's indexed clothing.
 */
class TopAdapter(private val dataList: MutableList<Top>, val context: Context): RecyclerView.Adapter<TopAdapter.ViewHolder>() {
